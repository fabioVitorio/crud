...
<html lang="pt-br">
    ...
    <body>
      ...
      <div style="margin-top: 30px;">
        <h3 class="text-center">CADASTRO DE DESENVOLVEDORES</h3>
      </div>
      ...
      <div style="padding: 20px 0 20px 0;">
        ...
        <div class="col-md-4">
            ...
            <div class="input-group has-validation">
              ...
              <input type="text" class="form-control border border-secondary" id="nome" aria-describedby="inputGroupPrepend" required>
            </div>
          </div>
          ...
          <div class="col-md-4">
            ...
            <div class="input-group has-validation">
              ...
              <input type="text" class="form-control border border-secondary" id="cpf" aria-describedby="inputGroupPrepend" required>
            </div>
          </div>
          ...
          <div class="col-md-4">
            ...
            <div class="input-group has-validation">
              ...
              <input type="text" class="form-control border border-secondary" id="github" aria-describedby="inputGroupPrepend" required>
            </div>
          </div>
          ...
          <div class="col-md-3">
            ...
            <div class="input-group has-validation">
              ...
              <input type="date" class="form-control border border-secondary" id="data_nasc" aria-describedby="inputGroupPrepend" required>
            </div>
          </div>
          ...
          <div class="col-md-4">
            ...
            <textarea class="form-control border border-secondary" name="" id="endereco" cols="2" rows="3" style="resize: none;" maxlength="250" required></textarea>
          </div>
